        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-slate-800/90 backdrop-blur-sm rounded-2xl p-8 border border-slate-700 shadow-2xl">
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl font-bold text-white">Sign in to Argus</h1>
              <p className="text-slate-400 mt-2">Strategic Intelligence Platform</p>
            </div>
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white hover:bg-gray-100 text-gray-900 font-medium rounded-lg transition disabled:opacity-50"
              >
              ...
              <button
                ...
                disabled={loading !== null}
                className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-slate-700 hover:bg-slate-600 text-white font-medium rounded-lg transition disabled:opacity-50"
              >
              ...
              <button
                ...
                disabled={loading !== null}
                className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-slate-900 hover:bg-slate-800 text-white font-medium rounded-lg border border-slate-600 transition disabled:opacity-50"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            {showEmailForm ? (
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-slate-700/50 hover:bg-slate-700 text-white font-medium rounded-lg transition border border-slate-600"
              >
            ...
            <p className="text-center text-slate-400 text-sm mt-6">
              ...
              <Link href="/" className="text-argus-400 hover:text-argus-300">
                Get Started
              </Link>
            </p>
          </div>
          ...
          <div className="mt-6 text-center text-slate-500 text-sm">
            <p>
              <strong className="text-slate-400">Standard users</strong> sign in with OAuth for full platform access.
            </p>
            <p className="mt-1">
              <strong className="text-slate-400">HUMINT sources</strong> use anonymous passkeys to protect their identity.
            </p>
          </div>
        </div>
      </div>
