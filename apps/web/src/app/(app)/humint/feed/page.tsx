              ...
              <article key={post.id} className="px-4 py-4 hover:bg-gray-900/50 transition-colors">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {/* Actions - Icon only, mobile optimized */}
                    <div className="flex items-center justify-between mt-3 text-gray-500 max-w-[280px]">
                      ...
                      <button 
                        ...
                        className="flex items-center gap-1.5 hover:text-emerald-400 transition-colors p-2 -m-2"
                      >
                      ...
                      <button 
                        ...
                        className={`flex items-center gap-1.5 transition-colors p-2 -m-2 ${post.liked ? 'text-red-400' : 'hover:text-red-400'}`}
                      >
                        <svg className="w-[18px] h-[18px]" fill={post.liked ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      {post.isOwner && (
                        <button 
                          ...
                          className="flex items-center hover:text-red-400 transition-colors p-2 -m-2"
                        >
                          <svg className="w-[18px] h-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
